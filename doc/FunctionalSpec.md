...
(**a**) The **Microbiologist** is here for the preliminary results/confirmation. The lab intern might have mislablled some (~100) of the samples. Does that say a *Turdis turdis* sample or just a *Turtle's turds* sample? They don't want to have to throw out all those samples..
